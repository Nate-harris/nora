...
const Icon = observer(() => {
  ...
  return (
    ...
    >
      <motion.g animate={{ fill: menuOpen ? "var(--white)" : "var(--orange)" }}>
...
const Hamburger = observer(({ onClick }) => {
  ...
  return (
    ...
    >
      ...
      >
        <motion.g
          animate={{ fill: menuOpen ? "var(--white)" : "var(--orange)" }}
        >
          <motion.path
